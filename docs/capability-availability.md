...
| [Published npm package](https://registry.npmjs.org/@blopai%2Fbrowser-harness/latest) | `@blopai/browser-harness` 0.1.8 is a public MIT package whose homepage and repository point back to this repository.                                                                                                                                                                                                                                                                                                                                                  | npm `latest` registry metadata for version 0.1.8.                                                | August 14, 2026 |
