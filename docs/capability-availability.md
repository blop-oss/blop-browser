...
| Chrome and CDP         | Managed Chromium is local. Existing Chrome attachment accepts an explicit endpoint only with `--attach-existing`, and preserves the external profile on destroy. See the [attachment gate](../src/cli.ts#L594-L643) and [external-profile test](../test/cli/cli.test.ts#L884-L976).                                                                                                                                                                     | Not offered by this project (N/A). | Not offered by this project (N/A). |
| Camoufox               | Optional Camoufox runs as a separately installed local browser or in a self-operated warm container. See the [launch paths](../src/cli/runtime.ts#L112-L165) and [container test](../test/session/camoufox-container.test.ts#L21-L51).                                                                                                                                                                                                                  | Not offered by this project (N/A). | Not offered by this project (N/A). |
