...
| Explicit existing-Chrome reuse    | [Attachment authorization gate](../src/cli.ts#L589-L639), [CDP connection implementation](../src/cli/runtime.ts#L98-L124), and [local CDP regression test](../test/cli/cli.test.ts#L731-L823)                                                                                     | Existing-profile access is opt-in through `--attach-existing`. The loopback proof deliberately does not attach to a user profile or claim isolation for that external profile.                                                                                                                                                                           |
| Chromium and Camoufox portability | [Managed launch implementations](../src/cli/runtime.ts#L98-L153) and [warm container APIs](../src/index.ts#L56-L71)                                                                                                                                                               | Chromium is the default. Camoufox is an optional third-party browser for authorized compatibility testing; support does not promise identical rendering, anonymity, or bypass of site controls.                                                                                                                                                          |
| Inspectable action evidence       | [Ordered CLI export proof](../scripts/demo-positioning-proof.mjs#L210-L362), [bounded trace recorder](../src/trace-recorder.ts#L115-L273), [CLI persistence and lifecycle integration](../src/cli/runtime.ts#L231-L374), and the [action trace contract](action-traces.md#L1-L21) | The CLI exports a bounded ordered harness action trace as JSON or a human timeline, including success, failure, lifecycle, identity, read/write, target-ref, and content-boundary evidence. Persistent sessions retain it across close. This is harness action evidence, not native Playwright tracing, video, DOM snapshots, network bodies, or replay. |
| Safety and provenance boundary    | [Read-only and disposal proof](../scripts/demo-positioning-proof.mjs#L379-L472) and [static policy and content-boundary enforcement](../src/tools/safety.ts#L16-L216)                                                                                                             | The harness denies statically classified interactions before Playwright dispatch and labels browser-derived content untrusted. It does not understand business consequences, prevent prompt injection, or sandbox page loading.                                                                                                                          |
| Framework-neutral embedding       | [Public TypeScript exports](../src/index.ts#L16-L81) and [tool factory contract](../src/create-tools.ts#L43-L220)                                                                                                                                                                 | The package supplies browser tools, session primitives, and evidence hooks. The host still owns the model loop, prompts, approval UI, reporting, uploads, and task policy.                                                                                                                                                                               |
